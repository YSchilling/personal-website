...
<template>
    <section id="mainsection" class="grid grid-cols-12">
        ...
        <div class="col-start-3 col-span-8">
            ...
            <button class="mb-4 text-highlight underline hover:no-underline" v-if="isHidingContacts" @click="isHidingContacts = false">Show Contacts</button>
            <div v-else v-html="decode(contact)"></div>
            <h2 class="text-xl mb-4"><b>Haftungsausschluss: </b></h2>
            <p class="mb-4">
                <b class="mb-2">Haftung für Inhalte</b><br>
            ...
            <p class="mb-4">
                <b class="mb-2">Haftung für Links</b><br>
            ...
            <p class="mb-4">
                <b class="mb-2">Urheberrecht</b><br>
            ...
            <p class="mb-8">
                ...
                Zustimmung nicht an Dritte weitergegeben. Wir weisen darauf hin, dass die Datenübertragung im Internet (z.B. bei der Kommunikation per E-Mail)
            ...
            <p class="mb-8">
            Website Impressum erstellt durch <a href="https://www.impressum-generator.de" class="underlin">impressum-generator.de</a> von der
            <a href="https://www.kanzlei-hasselbach.de/" rel="nofollow">Kanzlei Hasselbach</a></p>
        </div>
    </section>
    <Footer />
</template>